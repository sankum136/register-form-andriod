...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView date, first_name, last_name, email,  date_of_birth;
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (first_name.getText().toString().equals("")) {
                    ...
                    if (first_name.getError() == null && last_name.getError() == null && email.getError() == null && date_of_birth.getError() == null)  {
